...
export default function DriverMapView() {
          ...
          <div className="max-w-md mx-auto space-y-4">
            ...
            <div className="space-y-3">
              <Input
                ...
                dir="ltr"
              />
              <Button className="w-full" onClick={initializeMap} disabled={!mapboxToken}>
                تفعيل الخريطة
              </Button>
            </div>
  ...
  return (
    <div className="h-[calc(100vh-8rem)] relative">
      ...
      <div className="absolute top-4 left-4 bg-card border border-border px-3 py-2 z-10 text-sm font-medium">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-card border-t border-border p-4 z-10">
          <div className="max-w-md mx-auto space-y-4">
            ...
            <div className="flex gap-3">
              <Button className="flex-1" onClick={handleNavigate} disabled={selectedSpot.status !== 'available'}>
